...
attr <- read.table("~/Box/GeberA_TophamLab/03-GTEx_Human_Metabolism/metadata/GTEx_Analysis_v8_Annotations_SampleAttributesDS.txt", header = TRUE, row.names = 1, sep = "\t", quote = "", stringsAsFactors = FALSE, fill = FALSE)
...
pheno <- read.table("~/Box/GeberA_TophamLab/03-GTEx_Human_Metabolism/metadata/GTEx_Analysis_v8_Annotations_SubjectPhenotypesDS.txt", sep = "\t", quote = "", fill = TRUE, header = TRUE)
