...
fluximplied <- function(genes,species,format) {
  ...
  #RLSdatabase<-read.csv('https://raw.githubusercontent.com/msport469/fluximplied/master/RLSdatabase.csv?token=ANC4YV6CMWQ3MBVHDWILXG3ARNO56',stringsAsFactors = F)
